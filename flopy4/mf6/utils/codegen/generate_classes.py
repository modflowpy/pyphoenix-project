...
_SKIP = {
    ...
    "sim-tdis",
    # solution (hand-written ims.py and ems.py)
    "sln-ims",
    "sln-ems",
    # packages with hand-written nested record types not yet generated
    "gwf-oc",
    "gwf-npf",
    # SSM: needs recarray codec support for the sources table
    # (pname/srctype/auxname per row)
    "gwt-ssm",
    "gwe-ssm",
    # BUY/VSC: packagedata requires row-per-record table format; autogenerated
    # separate-array approach produces incorrect output
    "gwf-buy",
    "gwf-vsc",
