...
@xattree
class Dis(DisBase):
    length_units: str = field(block="options", default=None, longname="model length units")
    ...
    nlay: int = dim(
        block="dimensions", coord="lay", scope="prt", default=1, longname="number of layers"
    )
    ncol: int = dim(
        block="dimensions", coord="col", scope="prt", default=2, longname="number of columns"
    )
    nrow: int = dim(
        block="dimensions", coord="row", scope="prt", default=2, longname="number of rows"
    )
    ...
    nodes: int = dim(coord="node", scope="prt", init=False)
    ncpl: int = dim(coord="c", scope="prt", init=False)
    nvert: int = dim(coord="vert", scope="prt", init=False)
